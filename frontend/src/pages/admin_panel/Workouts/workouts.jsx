...
const Workouts = () => {
    ...
    const {ok,error,setError,deleteWorkout} =useWorkout(false)
    ...
    const [errorText, seterrorText] = useState("No se ha podido eliminar el entrenamiento, intentelo de nuevo.");
    ...
    const columns = [
      ...
      },
        {
            ...
            width: 100,
            renderCell: (params) => {
                return (<Button className="btn" variant="outlined" color="secondary" size="small" onClick={()=>{deleteWorkout(params.row);setrefresh(params.id)}}><DeleteIcon /></Button>)
            },
        },
    ];
        ...
        <>
            {
                ...
                <>
                  ...
                  <div className="categoriesAdmin">
                      <DataGrid rows={workoutsAdmin} columns={columns} pageSize={20} checkboxSelection={false} />
